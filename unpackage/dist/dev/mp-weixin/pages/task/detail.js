...
var _detail = _interopRequireDefault(__webpack_require__(/*! ./pages/task/detail.vue */ 82));
// @ts-ignore
...
/* harmony import */ var _detail_vue_vue_type_template_id_0417eeb2___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./detail.vue?vue&type=template&id=0417eeb2& */ 83);
...
try {
  components = {
    uniSteps: function () {
      return __webpack_require__.e(/*! import() | uni_modules/uni-steps/components/uni-steps/uni-steps */ "uni_modules/uni-steps/components/uni-steps/uni-steps").then(__webpack_require__.bind(null, /*! @/uni_modules/uni-steps/components/uni-steps/uni-steps.vue */ 141))
    },
  }
} catch (e) {
  if (
  ...
  methods: {
    getDetail: function getDetail() {
      ...
      wx.cloud.callFunction({
        ...
        _this.stepList[1].desc = obj.oTime;
        _this.stepList[2].desc = obj.jTime;
        _this.stepList[3].desc = obj.fTime;
      }).catch(console.error);
    },
